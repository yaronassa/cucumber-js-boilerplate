Feature: Demonstrating meta-test boilerplate
  ...
  Scenario: No real scenario contains debug steps
    ...
    #Uncomment the relevant line in src/features/demo/demo_meta.feature to see the test fail
  
  Scenario: All real scenarios adhere to custom rules (when applicable)
    #Uncomment the relevant lines in src/features/demo/demo_meta.feature to see the test fail
